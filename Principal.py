...
def menu_tecnicos():
    ...
    def edit_tec():
        ...
        if flag_sel:
            ...
            label_codigo = tk.Label(tec_janela3, text=f'Código: {codigo1}', bg="#254E58", fg="#88BDBC",
                                    activebackground="#45A29E", activeforeground="#112D32",
                                    font=("Helvetica", 10, "bold"))
            label_codigo.pack(ipady=10)

            label_nome = tk.Label(tec_janela3, text="Nome:", bg="#254E58", fg="#88BDBC",
                                  activebackground="#45A29E", activeforeground="#112D32",
                                  font=("Helvetica", 10, "bold"))
            ...
            label_cpf = tk.Label(tec_janela3, text="CPF (Somente números):", bg="#254E58", fg="#88BDBC",
                                 activebackground="#45A29E", activeforeground="#112D32",
                                 font=("Helvetica", 10, "bold"))
            ...
            label_contato = tk.Label(tec_janela3, text="Contato:", bg="#254E58", fg="#88BDBC",
                                     activebackground="#45A29E", activeforeground="#112D32",
                                     font=("Helvetica", 10, "bold"))
            ...
            label_turno = tk.Label(tec_janela3, text="Turno:", bg="#254E58", fg="#88BDBC",
                                   activebackground="#45A29E", activeforeground="#112D32",
                                   font=("Helvetica", 10, "bold"))
            ...
            label_equipe = tk.Label(tec_janela3, text="Equipe:", bg="#254E58", fg="#88BDBC",
                                    activebackground="#45A29E", activeforeground="#112D32",
                                    font=("Helvetica", 10, "bold"))
            ...
            botao_criar_codigo = tk.Button(tec_janela3, text="Salvar alterações", bg="#254E58", fg="#88BDBC",
                                           activebackground="#45A29E", activeforeground="#112D32",
                                           font=("Helvetica", 12, "bold"), command=editar_codigo)
    ...
    def ins_tec():
        ...
        label_nome = tk.Label(tec_janela2, text="Nome:", bg="#254E58", fg="#88BDBC",
                              activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
        label_nome.pack(ipady=10)

        entry_nome = tk.Entry(tec_janela2)
        entry_nome.pack()

        label_cpf = tk.Label(tec_janela2, text="CPF (Somente números):", bg="#254E58", fg="#88BDBC",
                             activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
        label_cpf.pack(ipady=10)
        ...
        label_contato = tk.Label(tec_janela2, text="Contato:", bg="#254E58", fg="#88BDBC",
                                 activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
        label_contato.pack(ipady=10)
        ...
        label_turno = tk.Label(tec_janela2, text="Turno:", bg="#254E58", fg="#88BDBC",
                               activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
        label_turno.pack(ipady=10)
        ...
        label_equipe = tk.Label(tec_janela2, text="Equipe:", bg="#254E58", fg="#88BDBC",
                                activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
        label_equipe.pack(ipady=10)
        ...
        botao_criar_codigo = tk.Button(tec_janela2, text="Cadastrar Técnico", bg="#254E58", fg="#88BDBC",
                                       activebackground="#45A29E", activeforeground="#112D32",
    ...
    tec_janela.geometry("800x500+250+50")
    tec_janela.minsize(800, 500)
    tec_janela.maxsize(800, 500)
    tec_janela.config(bg='#112D32')
    tec_janela.iconbitmap('icon.ico')
    style = ttk.Style()
    style.configure("mystyle.Treeview", background='#254E58', foreground='#D1E8E2', highlightthickness=0, bd=0,
                    font=('Calibri', 10))  # Modify the font of the body
    style.configure("mystyle.Treeview.Heading", background='#D1E8E2', foreground='#112D32',
                    font=('Calibri', 11, 'bold'))  # Modify the font of the headings
    ...
    bt11 = tk.Button(tec_janela, text='Cadastrar', bg="#254E58", fg="#88BDBC", activebackground="#45A29E",
                     activeforeground="#112D32", font=("Helvetica", 16, "bold"), command=ins_tec)
    bt11.place(x=100, y=370)

    bt22 = tk.Button(tec_janela, text='Editar', bg="#254E58", fg="#88BDBC", activebackground="#45A29E",
                     activeforeground="#112D32", font=("Helvetica", 16, "bold"), command=edit_tec)
    bt22.place(x=270, y=370)

    bt33 = tk.Button(tec_janela, text='Excluir', bg="#254E58", fg="#88BDBC", activebackground="#45A29E",
                     activeforeground="#112D32", font=("Helvetica", 16, "bold"), command=del_tec)
    bt33.place(x=400, y=370)

    bt44 = tk.Button(tec_janela, text='Exportar Lista', bg="#254E58", fg="#88BDBC", activebackground="#45A29E",
                     activeforeground="#112D32", font=("Helvetica", 16, "bold"), command=exp_tec)
...
def menu_ferramentas():
    def edit_fer():
        ...
        if flag_sel:
            ...
            label_codigo = tk.Label(fer_janela3, text=f'Código: {codigo1}', bg="#254E58", fg="#88BDBC",
                                    activebackground="#45A29E", activeforeground="#112D32",
                                    font=("Helvetica", 10, "bold"))
            label_codigo.grid(row=0, column=2, padx=10, ipady=10)

            label_desc = tk.Label(fer_janela3, text="Descrição:", bg="#254E58", fg="#88BDBC",
                                  activebackground="#45A29E", activeforeground="#112D32",
                                  font=("Helvetica", 10, "bold"))
            ...
            label_fab = tk.Label(fer_janela3, text="Fabricante:", bg="#254E58", fg="#88BDBC",
                                 activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
            ...
            label_volt = tk.Label(fer_janela3, text="Voltagem:", bg="#254E58", fg="#88BDBC",
                                  activebackground="#45A29E", activeforeground="#112D32",
                                  font=("Helvetica", 10, "bold"))
            ...
            label_part = tk.Label(fer_janela3, text="Part Number:", bg="#254E58", fg="#88BDBC",
                                  activebackground="#45A29E", activeforeground="#112D32",
                                  font=("Helvetica", 10, "bold"))
            ...
            label_tam = tk.Label(fer_janela3, text="Tamanho:", bg="#254E58", fg="#88BDBC",
                                 activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
            ...
            label_um = tk.Label(fer_janela3, text="Unidade de medida:", bg="#254E58", fg="#88BDBC",
                                activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
            ...
            label_tipo = tk.Label(fer_janela3, text="Tipo de ferramenta:", bg="#254E58", fg="#88BDBC",
                                  activebackground="#45A29E", activeforeground="#112D32",
                                  font=("Helvetica", 10, "bold"))
            ...
            label_mat = tk.Label(fer_janela3, text="Material:", bg="#254E58", fg="#88BDBC",
                                 activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
            ...
            label_temp = tk.Label(fer_janela3, text="Tempo máximo:", bg="#254E58", fg="#88BDBC",
                                  activebackground="#45A29E", activeforeground="#112D32",
                                  font=("Helvetica", 10, "bold"))
            ...
            botao_criar_codigo = tk.Button(fer_janela3, text="Salvar alterações", bg="#254E58", fg="#88BDBC",
                                           activebackground="#45A29E", activeforeground="#112D32",
                                           font=("Helvetica", 10, "bold"),
        ...
        if search_entry.get():
            ...
            for child in tv2.get_children():
                ...
                if query.title() in tv2.item(child)['values']:
                    selections.append(child)
                if query.upper() in tv2.item(child)['values']:  # compare strings in  lower cases.
                    selections.append(child)
    ...
    def ins_fer():
        ...
        label_desc = tk.Label(fer_janela2, text="Descrição:", bg="#254E58", fg="#88BDBC",
                              activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
        ...
        label_fab = tk.Label(fer_janela2, text="Fabricante:", bg="#254E58", fg="#88BDBC",
                             activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
        ...
        label_volt = tk.Label(fer_janela2, text="Voltagem:", bg="#254E58", fg="#88BDBC",
                              activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
        ...
        label_part = tk.Label(fer_janela2, text="Part Number:", bg="#254E58", fg="#88BDBC",
                              activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
        ...
        label_tam = tk.Label(fer_janela2, text="Tamanho:", bg="#254E58", fg="#88BDBC",
                             activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
        ...
        label_um = tk.Label(fer_janela2, text="Unidade de medida:", bg="#254E58", fg="#88BDBC",
                            activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
        ...
        label_tipo = tk.Label(fer_janela2, text="Tipo de ferramenta:", bg="#254E58", fg="#88BDBC",
                              activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
        ...
        label_mat = tk.Label(fer_janela2, text="Material:", bg="#254E58", fg="#88BDBC",
                             activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
        ...
        label_temp = tk.Label(fer_janela2, text="Tempo máximo de reserva (horas):", bg="#254E58", fg="#88BDBC",
                              activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 10, "bold"))
        ...
        botao_criar_codigo = tk.Button(fer_janela2, text="Cadastrar ferramenta", bg="#254E58", fg="#88BDBC",
                                       activebackground="#45A29E", activeforeground="#112D32",
                                       font=("Helvetica", 10, "bold"),
    ...
    fer_janela.geometry("800x500+250+50")
    fer_janela.minsize(800, 500)
    fer_janela.maxsize(800, 500)
    fer_janela.config(bg='#112D32')
    ...
    def Load_excel_data():
        ...
        df2_rows = df2.to_numpy().tolist()  # turns the dataframe into a list of lists
        for row in df2_rows:
    ...
    bt11 = tk.Button(fer_janela, text='Cadastrar', bg="#254E58", fg="#88BDBC", activebackground="#45A29E",
                     activeforeground="#112D32", font=("Helvetica", 16, "bold"), command=ins_fer)
    bt11.place(x=100, y=370)

    bt22 = tk.Button(fer_janela, text='Editar', bg="#254E58", fg="#88BDBC", activebackground="#45A29E",
                     activeforeground="#112D32", font=("Helvetica", 16, "bold"), command=edit_fer)
    bt22.place(x=270, y=370)

    bt33 = tk.Button(fer_janela, text='Excluir', bg="#254E58", fg="#88BDBC", activebackground="#45A29E",
                     activeforeground="#112D32", font=("Helvetica", 16, "bold"), command=del_fer)
    bt33.place(x=400, y=370)

    bt44 = tk.Button(fer_janela, text='Exportar Lista', bg="#254E58", fg="#88BDBC", activebackground="#45A29E",
                     activeforeground="#112D32", font=("Helvetica", 16, "bold"), command=exp_fer)
    bt44.place(x=550, y=370)
...
main_janela.title("Gerenciador de Ferramentas V1.0")
main_janela.geometry('800x500+250+50')
main_janela.minsize(800, 500)
main_janela.maxsize(800, 500)
main_janela.config(bg='#112D32')
...
ttk.Label(image=logo, borderwidth=0, background='#112D32').place(x=56, y=5)

botao_tecnicos = tk.Button(main_janela, text="Cadastro de Técnicos", bg="#254E58", fg="#88BDBC",
                           activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 16, "bold"),
                           command=menu_tecnicos)
botao_tecnicos.place(x=260, y=275, height=45, width=280)

botao_ferramentas = tk.Button(main_janela, text="Cadastro de Ferramentas", bg="#254E58", fg="#88BDBC",
                              activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 16, "bold"),
                              command=menu_ferramentas)
botao_ferramentas.place(x=260, y=350, height=45, width=280)

botao_reservas = tk.Button(main_janela, text="Reservas de Ferramentas", bg="#254E58", fg="#88BDBC",
                           activebackground="#45A29E", activeforeground="#112D32", font=("Helvetica", 16, "bold"),
                           command=None)
